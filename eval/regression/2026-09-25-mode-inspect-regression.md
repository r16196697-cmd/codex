...
| T9 Purge barrier / restore | PARTIAL | Active Run + UNKNOWN Effect remains PARTIAL and is inspected/rendered without a completion claim; old-backup PurgeLedger anti-resurrection and the new full T12 Recovery-mode old-snapshot replay drill pass. Remaining T9 crash/quiescence/derived-identifier cases are not all exercised as one acceptance scenario. |
