...
| T9 Purge barrier / restore | PARTIAL | Active Run + UNKNOWN Effect remains PARTIAL and is inspected/rendered without a completion claim; old-backup anti-resurrection and T12 Recovery drill pass. New fault injection interrupts after external barrier journal append but before SQLite install; replay restores a persistent PARTIAL barrier and blocks derived writes after reopen. Other crash/quiescence/derived-identifier cases remain uncovered as a complete acceptance scenario. |
