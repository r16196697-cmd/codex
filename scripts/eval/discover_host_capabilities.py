...
def build_inventory(*, home: Path, repo_root: Path, skill_roots: list[tuple[Path, str]], runtime_tools: int | None,
    ...
    summary = {
        ...
        "host_tool_registry": {"status": "OBSERVED_RUNTIME_TOOL_METADATA" if runtime_tools is not None else "UNAVAILABLE", "tool_count": runtime_tools,
            "mcp_tool_count": mcp_tools, "mcp_server_count": mcp_servers, "ui_skill_catalog_count": "UNAVAILABLE"},
